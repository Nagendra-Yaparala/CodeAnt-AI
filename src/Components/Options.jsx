...
const Options = () => {
  ...
  return (
    <div className="rounded-3xl shadow-lg border border-[#E9EAEB] py-6 px-10">
      <h1 className="font-bold text-xl flex text-center align-middle"><img className='mr-2' src={Subtract} alt="" />    AI to Detect & Autofix Bad Code</h1>
